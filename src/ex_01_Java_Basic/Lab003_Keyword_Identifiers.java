...
public class Lab003_Keyword_Identifiers {
    public static void main(String[] args) {
        System.out.println("Let's learn about Keywords & Identifiers");
        //Keywords are reserved words, they are defined in lower case & cannot be used while creating any class, method, variables, etc.
